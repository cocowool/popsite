...
function entry(cwd = process.cwd(), args){
    ...
    program
        ...
        .usage('<markdown_file> [--output <html_file>]')
        .option('-o, --html_file', 'Specify Output Html File')
    ...
    console.log(program.html_file);

    if ( file_name ) {
        // Get Current Folder
        file_name = process.cwd() + '/' + file_name
        // console.log(process.argv);
        ...
        Popsite.markdown2html(file_name)
    }
